...
mediawiki_api_endpoint = 'http://fluidseal.smarter.codes/w/api.php'

# SPARQL endpoint
wikibase_sparql_endpoint = 'http://query-fluidseal.smarter.codes/proxy/wdqs/bigdata/namespace/wdq/sparql'

# Name of the Wikibase instance
wikibase_name = 'WikibaseFS'

# URL of the main page of the Wikibase instance
wikibase_main_page = 'http://fluidseal.smarter.codes/wiki/Main_Page'
...
import re
q_re = re.compile(r'(<?http?://fluidseal.smarter.codes/(entity|wiki)/)?(Q[0-9]+)>?')
q_re_group_id = 3
p_re = re.compile(r'(<?http?://fluidseal.smarter.codes/(entity/|wiki/Property:))?(P[0-9]+)>?')
p_re_group_id = 3
...
identifier_space = 'http://fluidseal.smarter.codes/entity/'
schema_space = 'http://fluidseal.smarter.codes/prop/direct/'
...
qid_url_pattern = 'http://fluidseal.smarter.codes/wiki/Item:{{id}}'
...
service_name = 'Reconcile for WikibaseFS.'

# URL (without the trailing slash) where this server runs
this_host = 'http://reconciliation-fluidseal.smarter.codes'
